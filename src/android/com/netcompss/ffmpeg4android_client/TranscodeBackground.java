...
//			notifMessage = _act.getString(R.string.notif_message_stopping);
//		else {
//			 notifMessage = _act.getString(R.string.notif_message_ok);
//		}
...
//			String notifTitle = _act.getString(R.string.notif_message_stopped);
...
//			notification.setLatestEventInfo(_act, notifTitle, "", pIntent);
			...
			String outputFileURL = _prefs.getOutFolder() + _act.getOutputFile();
			Intent i = new Intent("yw.wemet.ngageapp.USER_ACTION_COMPRESSION");
			i.putExtra("filePath", outputFileURL);
			i.putExtra("compression", false);
			_act.getApplicationContext().sendBroadcast(i);
		}
