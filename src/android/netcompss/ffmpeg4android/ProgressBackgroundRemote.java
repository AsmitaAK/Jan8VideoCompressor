...
//	private Notification _notification;
	...
	long _timeRef = -1;
	int _prevProgress;
	FFMpegRemoteServiceBridgeCompression _bridge;
	
	public ProgressBackgroundRemote(int notificationId, Context context, Notification notification, FFMpegRemoteServiceBridgeCompression bridge) {
